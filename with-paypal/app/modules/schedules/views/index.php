                ...
                <div class="header">
                    <div class="form-inline">
                        <div class="btn-group" role="group">
                            ...
                            <a class="btn bg-grey waves-effect btnActionModule" data-action="delete_all" data-categoty="post" data-confirm="<?=l('Are you sure you want to delete all items?')?>" href="javascript:void(0);">
                                <?=l('Delete all')?>
                            </a>
                        </div>
                    </div>
